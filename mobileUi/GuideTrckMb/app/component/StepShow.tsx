...
const steps = [
    ...
    { step: 6, title: "Time", description: "Managing the timeline efficiently", icon: "clock-o", image: "https://via.placeholder.com/200", audio: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3" },
    { step: 7, title: "Success", description: "Achieving the final goal", icon: "flag-checkered", image: "https://via.placeholder.com/200", audio: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3" },
